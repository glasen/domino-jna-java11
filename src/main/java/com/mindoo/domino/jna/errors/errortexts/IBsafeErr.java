...
public interface IBsafeErr extends IGlobalErr {
	...
	short ERR_BSAFE_PSW_PROMPT = (PKG_BSAFE);
	...
	short ERR_BSAFE2_ATTRIBUTE_UNKNOWN = (PKG_BSAFE2);
	...
	short ERR_BSAFE3_TE_UNKNOWN = (PKG_BSAFE3);
	...
	short ERR_BSAFE_UNSUPPORTED_CERTCRLSIG = (PKG_BSAFE4);
	...
	short ERR_BSAFE_RECOVERY_INFO_TOO_OLD = (PKG_BSAFE5);
	...
	short ERR_BSAFE_TE_UNTRUSTED_SIGNER = (PKG_BSAFE6);
